...
- `puppet` and `puppet-master` demonstrate usage of CPI and how to call another program using Anchor CPI feature. Good for breaking down a complex program into smaller pieces
